...
class rcc
{
		...
		{
			GPIO_PORTA, GPIO_PORTB, GPIO_PORTC, GPIO_PORTD, GPIO_PORTE, GPIO_PORTF, GPIO_PORTG, GPIO_PORTH
		};

		enum class USART_Port
		{
			USART_PORT1, USART_PORT2, USART_PORT3
		};

		enum class I2C_Port
		{
			I2C_PORT1, I2C_PORT2, I2C_PORT3
		};

		enum class SPI_Port
		{
			SPI_PORT1, SPI_PORT2, SPI_PORT3
		};
		...
		enum class TIM_Port
		{
			TIM_PORT1, TIM_PORT2, TIM_PORT3, TIM_PORT4, TIM_PORT5, TIM_PORT6, TIM_PORT7, TIM_PORT8, TIM_PORT15,
			TIM_PORT16, TIM_PORT17
		};
